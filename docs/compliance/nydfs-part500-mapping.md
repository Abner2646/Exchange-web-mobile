...
| 500.5 | Vulnerability mgmt & penetration testing (annual) | 🟡 | **Dependency scanning in CI (§4.6): `npm audit` hard gate at high/critical + Dependabot weekly PRs** (`.github/workflows/ci.yml`, `.github/dependabot.yml`); tree clean at high/critical. Automated tests + mutation testing on money modules; `/security-review` available. No formal pentest yet | Documented pentest pass pre-mainnet |
