...
const errorCodes = Object.freeze({
  ...
  CONFIG_INVALID_INPUT: 'CONFIG_INVALID_INPUT',

  // Cambio de email (Radar #14)
  ...
  P2P_TX_OFFER_INACTIVE: 'P2P_TX_OFFER_INACTIVE',
  P2P_TX_AMOUNT_OUT_OF_RANGE: 'P2P_TX_AMOUNT_OUT_OF_RANGE',
  P2P_TX_INSUFFICIENT_FUNDS: 'P2P_TX_INSUFFICIENT_FUNDS',
});
