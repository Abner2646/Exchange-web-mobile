...
// —la address EVM no depende de la network, sólo cambian chainId/RPC/explorer/confirm—
// así que acá NO hay valores de derivación en juego. El perfil centraliza la
// identidad de network (chainId, name, confirmaciones) y NOMBRA las env keys de los
...
describe('EVM network profiles', () => {
  test('ethereum: mainnet vs sepolia (chainId + name)', () => {
  ...
  test('bsc: mainnet vs testnet (chainId + name)', () => {
