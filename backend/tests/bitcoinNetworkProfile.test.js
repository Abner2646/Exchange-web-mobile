...
// mainnet para BTC" (objeto de network bitcoinjs, coin type BIP44, explorador,
// confirmaciones). Antes esto estaba disperso como `isTestnet` leído de env en
// cada punto, la fuente del bug BIP84-vs-BIP44 y de direcciones cruzadas de network.
...
// una dirección p2wpkh con la network del perfil prueba el address space sin depender
// de ECPair ni de network.
...
describe('bitcoinNetworkProfile', () => {
  test('mainnet: network bitcoin, coin type BIP44 = 0, direcciones bc1', () => {
  ...
  test('testnet3 (default): network testnet, coin type BIP44 = 1, direcciones tb1', () => {
