...
export const ENDPOINTS = {
  ...
  USER_FORGOT_PASSWORD: '/usuario/forgot-password',
  USER_VERIFY_RESET_CODE: '/usuario/verify-reset-code',
  USER_RESET_PASSWORD: '/usuario/reset-password',
